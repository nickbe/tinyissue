...
class Project
{
    ...
    protected function handleIssueRequest(Request $request)
    {
        ...
        return $this->isBelongToProject($project, $issue);
    }
     ...
     * @return bool
     */
    protected function isBelongToProject($project, $entity)
    {
    ...
    protected function handleNoteRequest(Request $request)
    {
        /** @var ProjectModel|null $project */
        $project = $request->route()->getParameter('project');
        /** @var ProjectModel\Note|null $note */
        $note = $request->route()->getParameter('note');

        return $this->isBelongToProject($project, $note);
    }
}
